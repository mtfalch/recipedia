      ...
      <div class="container-fluid">
          ...
          <ul class="navbar-nav">
              <li class="nav-item active">
                  <a class="navbar-brand" href="../mainpage.html"><img src="../img/logo.png" height="30" width="100"></a>
              </li>
              <li class="nav-item">
          ...
          <!-- Search function -->
          <form class="form-inline" action="../search_post method/result.php" method = "post">
        ...
        <?php
            ...
            //connect to the server and select database
             ...
             $que_dish = "select DISTINCT sum(likes), dishName, imgscr, `tag_join_dish`.tagName, `tag_join_dish`.dishID
              ...
              while($row = $result->fetch_assoc())
              {
                ...
                echo "Rating: ".$row['sum(likes)']."<br>";

                ?>

                <button type='button'name='like'>like</button>
                <button type='button' name='dislike'>dislike</button><br>
